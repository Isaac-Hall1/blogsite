...
from .views import BlogPostCreate, TotalBlogList, MyBlogList, DeleteBlog, UpdateUpvotes, SpecificBlog, CreateComment
...
urlpatterns = [
    ...
    path('blog/comments/', CreateComment.as_view(), name = 'blog-comments' )
]