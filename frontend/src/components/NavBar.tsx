        ...
        <div className="flex items-center">
            ...
            <div className=" flex flex-grow items-center">
                <div className="flex flex-initial text-sm flex-grow">
                    <a href='/' className=" focus:text-teal-600  inline-block mt-0 text-teal-200 hover:text-white mr-4">Home</a>
                    <a href='/createblog' className="  focus:text-teal-600 inline-block mt-0 text-teal-200 hover:text-white mr-4">Create Blog</a>
                    <a href='/myposts' className="  focus:text-teal-600 inline-block mt-0 text-teal-200 hover:text-white mr-4">Your Posts</a>
                </div>
